...
using ReportingSystem.Application.TodoItems.Commands.CreateTodoItem;
using ReportingSystem.Application.TodoItems.Commands.DeleteTodoItem;
using ReportingSystem.Application.TodoItems.Commands.UpdateTodoItem;
using ReportingSystem.Application.TodoItems.Commands.UpdateTodoItemDetail;
using ReportingSystem.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace ReportingSystem.Web.Endpoints;
